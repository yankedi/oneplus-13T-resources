...
配套文件只登记不含访问口令的 [123 云盘资料入口](https://1817114020.share.123pan.cn/123pan/8MYVVv-QFmDh)；当前 tree 不再保存用户提供的访问口令。若该口令曾进入公开 Git 历史，应视为已经暴露，由资料所有者在 123 云盘侧轮换或撤销。本仓库没有下载、检查或重新上传该包，也没有确认其中各文件的项目来源、版本、许可证、哈希或安全性。
